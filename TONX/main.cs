...
public class Main : BasePlugin
{
    ...
    public const string PluginGuid = "cn.team-tonex.tonex";
    ...
    public static readonly string WebsiteUrl = Translator.IsChineseLanguageUser ? "https://TONEX.cc/zh" : "https://TONEX.cc";
    ...
    public override void Load()
    {
        ...
        TONEX.Logger.Msg("========= TONX loaded! =========", "Plugin Load");
    }
}
