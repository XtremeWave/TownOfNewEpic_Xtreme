...
public static class GameOptionsMenuPatch
{
    public static void Postfix(GameOptionsMenu __instance)
    {
        ...
        foreach (var tab in EnumHelper.GetAllValues<TabGroup>())
        {
            ...
            tohTab.transform.FindChild("Hat Button").FindChild("Icon").GetComponent<SpriteRenderer>().sprite = Utils.LoadSprite($"TONEX.Resources.Images.TabIcon_{tab}(150).png", 600f);
            tabs.Add(tohTab);
